...
@section('content')
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="{{ route('voiture.index') }}" class="btn btn-primary">ajouter/modifier/supprimer</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-xs-12">
            ...
            <div class="col-lg-4 col-md-4 col-xs-12 mt-5">
                <div class="card" style="width: 18rem;">
                    <img src="..." class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Reglages couverture</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="{{ route('couverture.index') }}" class="btn btn-primary">Couverture</a>
                    </div>
                </div>
            </div>
        </div>
